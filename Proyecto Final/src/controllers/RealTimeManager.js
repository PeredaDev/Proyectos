...
export class RealTimeManager {
    ...
    async initialize(){
        ...
        this.getNextId()
        console.log("Se ha inicializado el contructor RealTimeManager, el siguiente ID disponible: " + RealTimeManager.NextId)
    ...
    getNextId(){
        ...
        for (let element of sortedArray) {
            if (element.id != (previousId)) {
                RealTimeManager.NextId = previousId
                return
            }
            previousId++;
        }
